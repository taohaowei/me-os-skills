...
根据用户的开场话题或最近议题，按需加载对应镜头（`experts/`）+ thread + relations。
...
> **兜底规则**：任何含情绪词（焦虑、烦、累、紧张、心慌、压力大、睡不着、想哭）的开场——**不管它后面接的是什么话题**——都先用心理咨询镜头开 1-2 轮，再决定是否引入工作/健康镜头。情绪先于内容，永远是。
